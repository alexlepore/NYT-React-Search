...
var articleQuery = function(topic, beginYear, endYear){
  ...
  var authKey = "96302dd4d08c46b2929d9566d6e910f9";
  ...
  return new Promise(function (fulfill, reject){
    ...
    axios.get(queryURL).then(function(response) {
      ...
      // If GET gets a result, return only the first 5 articles
      if (response.data.response.docs[0]) {

        for(var i=0; i<response.data.response.docs.length; i++){
          // Break out of the loop if there are more than 7 entries
